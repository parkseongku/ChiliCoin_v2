...
In order to support loading of multiple wallets in chilicoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is chilicoin.cpp.
...
Changes to chilicoin.cpp
----------------------
chilicoin.cpp is the entry point into chilicoin-qt, and as such, will require some minor modifications to provide hooks for
