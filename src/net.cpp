...
static CSemachilicoin* semOutbound = NULL;
...
void static ProcessOneShot()
{
    ...
    CAddress addr;
    CSemachilicoinGrant grant(*semOutbound, true);
    if (grant) {
...
void ThreadOpenConnections()
{
    ...
    while (true) {
        ...
        CSemachilicoinGrant grant(*semOutbound);
        boost::this_thread::interruption_point();
...
bool OpenNetworkConnection(const CAddress& addrConnect, CSemachilicoinGrant* grantOutbound, const char* pszDest, bool fOneShot)
{
    //
...
void StartNode(boost::thread_group& threadGroup)
{
    ...
    if (semOutbound == NULL) {
        // initialize semachilicoin
        int nMaxOutbound = min(MAX_OUTBOUND_CONNECTIONS, nMaxConnections);
        semOutbound = new CSemachilicoin(nMaxOutbound);
    }
