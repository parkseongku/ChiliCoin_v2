...
/** Utility functions used by the ChiliCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render ChiliCoin addresses in monospace font
...
// Parse "chilicoin:" URI into recipient object, return true on successful parsing
