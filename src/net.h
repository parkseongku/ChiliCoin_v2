...
bool OpenNetworkConnection(const CAddress& addrConnect, CSemachilicoinGrant* grantOutbound = NULL, const char* strDest = NULL, bool fOneShot = false);
...
public:
    ...
    CSemachilicoinGrant grantOutbound;
