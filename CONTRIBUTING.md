Contributing to ChiliCoin Core
============================

The ChiliCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ChiliCoin Core project, and is not to be
confused with overall ChiliCoin Network Protocol consensus changes.

Whether a pull request is merged into ChiliCoin Core rests with the project merge
...
Patches that change ChiliCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the ChiliCoin consensus, it must have been
...
The project leader is the release manager for each ChiliCoin Core release.
